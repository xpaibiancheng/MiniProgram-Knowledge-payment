...
Page({
    ...
    onLoad(options) {
        ...
        wx.cloud.database().collection('studyVideo').doc(id).get({
            success:(res)=>{
                console.log(res);
                this.setData({
                    detailRow:res.data 
            ...
            wx.cloud.database().collection('orderStatus').where({
                ...
                success:(res)=>{
                    ...
                    if(res.data.length>0){
                        ...
                        wx.cloud.database().collection('videoProLists').add({
                            data:{
                                pre_id:that.data.detailRow._id,
    ...
    onShareAppMessage() {
        ...
        return {
            title:title ,
            path: 'pages/videoDetail/videoDetail?id='+id+'&'+'openid='+openid,
